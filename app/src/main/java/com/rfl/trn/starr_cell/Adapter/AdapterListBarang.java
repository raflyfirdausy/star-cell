                    ...
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()){
                                ...
                                myetDialogHarga1Barang.setText(String.valueOf(model.getHarga1()));
                                myetDialogHarga2Barang.setText(String.valueOf(model.getHarga2()));
                                myetDialogHarga3Barang.setText(String.valueOf(model.getHarga3()));
