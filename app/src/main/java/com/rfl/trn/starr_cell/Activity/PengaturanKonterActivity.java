...
public class PengaturanKonterActivity extends AppCompatActivity {
    ...
    private Context context = PengaturanKonterActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengaturan_konter);
        ButterKnife.bind(this);
        getSupportActionBar().setSubtitle("Pengaturan Konter");
