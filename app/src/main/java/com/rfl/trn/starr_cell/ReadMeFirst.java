...
public class ReadMeFirst {
    /*
    * Kie kelas aja di hapus, kon project e rapih
    * dadi di kategorikena per jenis
    * activity neng folder activity, model neng folder model , dan seteruse
    *
    * setiap Activity di wei Variable Context ya sekalian diisi
    * misal nang MainActivity.java digawe variable
